...
Since the results for the specified change set should not change, a pro-tip is to wrap queries like the above in an immutable PostgreSQL function so the output can be cached.
```
