...
BEGIN
  ...
  PERFORM delete_park_calendar_v1(v_change_set_id, 25);
  PERFORM delete_park_calendar_v1(v_change_set_id, 26);
  PERFORM delete_park_calendar_v1(v_change_set_id, 27);
  PERFORM delete_park_calendar_v1(v_change_set_id, 28);

  PERFORM delete_park_calendar_v1(v_change_set_id, 29);
  PERFORM delete_park_calendar_v1(v_change_set_id, 30);
  PERFORM delete_park_calendar_v1(v_change_set_id, 31);
  PERFORM delete_park_calendar_v1(v_change_set_id, 32);

  PERFORM delete_park_calendar_v1(v_change_set_id, 33);
  PERFORM delete_park_calendar_v1(v_change_set_id, 34);
  PERFORM delete_park_calendar_v1(v_change_set_id, 35);
  PERFORM delete_park_calendar_v1(v_change_set_id, 36);
